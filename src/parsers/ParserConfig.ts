/**
* File formats supported by DeMol
* @typedef FileFormats
* @category Parsers
...
* @prop mcif,cif Crystallographic Information File, the successor to ProteinFormat that makes you miss the ProteinFormat file format
* @prop mmtf Macromolecular Transmission Format, the successor to ProteinFormat that is totally awesome
* @prop mol2 Sybyl Mol2 format
* @prop pdb The venerable Protein Data Bank format
* @prop pqr Like ProteinFormat but with partial charges which are read into the partialcharge atom property
* @prop prmtop Amber topology file, must add coordinates
* @prop sdf MDL MOL format, supports multiple models and meta data
* @prop vasp DensityFormat format (CONTCAR, POSCAR)
* @prop xyz CoordinatesFormat cartesian coordinates format
*/
...
/**
 ...
 export interface ParserConfig {
  ...
  /** for formats without explicit bonds (e.g. ProteinFormat, xyz) infer bonding (default true).  */
  assignBonds?: boolean;
