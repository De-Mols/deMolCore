$DeMol.UI.Icons = (function () {
  function Icons() {
    this.move = `<svg  id="Layer_1" style="enable-background:new 0 0 32 32;" version="1.1" viewBox="0 0 32 32"  xml:space="preserve" xmlns="http:
    ...
    `;
    this.rotate = `<svg version="1.1" id="Icons" xmlns="http:
  ...
  <g
   ...
   <g
    ...
    `;
    this.option = ` <svg xmlns="http:
    this.minus = `<svg xmlns="http:
    this.plus = `<svg xmlns="http:
    this.paintbrush = `<?xml version="1.0" encoding="iso-8859-1"?>
    <!-- Generator: Adobe Illustrator 18.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
    <!DOCTYPE svg PUBLIC "-
    <svg version="1.1" id="Capa_1" xmlns="http:
...
<g>
   ...
   `;
    this.style = `<svg viewBox="0 0 24 24" fill="none" xmlns="http:
   ...
   `;
    this.visible = `<svg version="1.1" id="Capa_1" xmlns="http:
...
id="g40">
  ...
  <g>
    ...
    this.surface = `<svg version="1.1" id="Layer_1" xmlns="http:
...
`;
    this.molecule = `<svg version="1.1" id="Layer_1" xmlns="http:
